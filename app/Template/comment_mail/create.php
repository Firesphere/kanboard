...
<form method="post" action="<?= $this->url->href('CommentMailController', 'save', ['task_id' => $task['id']]) ?>"
      autocomplete="off" class="js-mail-form">
    <?= $this->form->csrf() ?>
    ...
    <?php if (!empty($members)): ?>
        <div class="dropdown">
            <a href="#" class="dropdown-menu dropdown-menu-link-icon"><i class="fa fa-address-card-o"></i><i
    ...
    <?php if (!empty($project['predefined_email_subjects'])): ?>
        <div class="dropdown">
            <a href="#" class="dropdown-menu dropdown-menu-link-icon"><i class="fa fa-archive"></i><i
                        class="fa fa-caret-down"></i></a>
            <ul>
