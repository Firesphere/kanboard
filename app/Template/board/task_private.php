<div class="
     ...
     data-task-url="<?= $this->url->href('TaskViewController', 'show', ['task_id' => $task['id']]) ?>">
        ...
        <div class="task-board-collapsed">
            ...
            <?php if ($this->user->hasProjectAccess('TaskModificationController', 'edit', $task['project_id'])): ?>
                ...
                <?php if ($this->projectRole->canUpdateTask($task)): ?>
                    <?= $this->modal->large('edit', '', 'TaskModificationController', 'edit', ['task_id' => $task['id']]) ?>
                <?php endif ?>
            <?php else: ?>
            ...
            <?php endif ?>
            <?= $this->url->link($this->text->e($task['title']), 'TaskViewController', 'show', ['task_id' => $task['id']], false, '', $this->text->e($task['title'])) ?>
        </div>
    <?php else: ?>
